!(function(e) {
    ...
    function n(e, t) {
        ...
        function Ce() {
            ...
            p
                ?
                Qe() :
                (O.trigger(e, [Re()]), !1 === u.beforeShow(Re()) ||
        ...
        function Re(e) {
            return (
                ...
                ue && ce ?
                null :
                tinycolor.fromRatio({ h: _, s: k, v: P, a: Math.round(1e3 * C) / 1e3 }, { format: e.format || ie })
            );
        }
        ...
        function He() {
            ...
            if (
                (re.removeClass("sp-clear-display"),
                    re.css("background-color", "transparent"), !a && ue)
            )
        ...
        function Ee() {
            ...
            if (
                (We && E.find("*:not(input)").attr("unselectable", "on"),
                    me(),
                    (fe = De('<span class="sp-original-input-container"></span>')), ["margin"].forEach(function(e) {
                        fe.css(e, O.css(e));
                    }),
            ...
            function a(e) {
                return (
                    ...
                    (Ae(De(e.target).closest(".sp-thumb-el").data("color")),
                        Fe(),
                        h.hideAfterPaletteSelect ? (Oe(!0), ze()) : Oe()), !1
                );
            }
            ve(),
                ...
                E.click(Ye), [$, O].forEach(function(t) {
                    t.change(function() {
                            ke(t.val());
                        }),
                        t.on("paste", function() {
    ...
    (function() {
        ...
        function P(e, t) {
            t = t || 6;
            for (
                var a = h(e).toHsv(), o = a.h, r = a.s, n = a.v, s = [], i = 1 / t; t--;
